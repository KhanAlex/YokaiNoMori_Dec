...
public class PlateauGraphic extends JPanel {
    ...
    public PlateauGraphic(Image img, Plateau plateau, Fenetre fenetre){
        ...
        imgSuperKodamaLoaded2 = new ImageIcon(new ImageIcon("kodamasamurai2.png").getImage().getScaledInstance(LARGEUR_PIECE,HAUTEUR_PIECE, Image.SCALE_DEFAULT));
        ...
        imgSuperOniLoaded2 = new ImageIcon(new ImageIcon("superoni2.png").getImage().getScaledInstance(LARGEUR_PIECE, HAUTEUR_PIECE, Image.SCALE_DEFAULT));
